...
SERVICE_DATA = {
  'CrossOver': {
    'logo_url': 'http://www.crossoverministry.org/images/template/logo.jpg',
    'website_url': 'http://www.crossoverministry.org',
    'main_contact_name': 'Main Contact Name',
    'description': '<p>CrossOver Healthcare Ministry provides quality and compassionate health care to the uninsured in the greater Richmond Metropolitan area.<p>Our mission is to provide health care, promote wellness, and connect the talents and resources of the community with people in need in the name of Jesus Christ. CrossOver is here to serve and empower patients by providing a comprehensive approach to health care for the body, mind, and spirit!</p>Established by volunteers in 1983, CrossOver offers a full continuum of health care services to the uninsured that includes: family medicine, primary care, obstetrics and pediatrics, podiatry, dental and vision care, mental health care, HIV diagnosis and treatment, and critical medications. CrossOver operates 2 free clinics located in areas of identified need in Richmond, serving more than 6,800 individuals annually.</p></p>We can put other free form text information here, such as services offered or screening days.</p>',
    'locations': [
      {
        'name': 'Cowardin',
    ...
    'users': [
      {'name': 'Username', 'phone': '123-456-7890','email': 'username@service.org' },
      {'name': 'Username', 'phone': '123-456-7890','email': 'username@service.org' },
      {'name': 'Username', 'phone': '123-456-7890','email': 'username@service.org' },
      {'name': 'Username', 'phone': '123-456-7890','email': 'username@service.org' },
      {'name': 'Username', 'phone': '123-456-7890','email': 'username@service.org' },
      {'name': 'Bob Lobblosen', 'phone': '123-456-7890','email': 'username@service.org' },
      {'name': 'Username', 'phone': '123-456-7890','email': 'username@service.org' },
      {'name': 'Username', 'phone': '123-456-7890','email': 'username@service.org' },
    ]
  },
  'Daily Planet': {
    'logo_url': 'http://www.dailyplanetva.org/wp-content/uploads/2014/03/Logo_banner.png',
    'website_url': 'http://www.dailyplanetva.org/',
    'main_contact_name': 'Main Contact Name',
    'description': 'The Daily Planet first opened its doors in 1969 to help the many teens who were dropping out of school and society.  These young people, who initially saw themselves as a sort of bohemian class, really amounted to a disenfranchised segment of young adults. These young adults really needed help.  The Daily Planet was organized and began offering shelter, meals, health clinics, and counseling to help them integrate back into society.',
    'locations': [
      {
  ...
  'Access Now': {
    'logo_url': 'http://www.ramdocs.org/graphics/header.jpg',
    'website_url': 'http://www.ramdocs.org/?page=AccessNow',
    'main_contact_name': 'Main Contact Name',
    'description': 'The greater Richmond area has a vast network of safety-net health clinics serving the primary care needs of the uninsured. These patients often also need the care of a specialist to diagnose and treat their complex health issues. When directors of local safety net clinics approached the Richmond Academy of Medicine with requests to expand their network of specialists to meet this need, the response was the development of Access Now. In January 2008, Access Now began operations, providing access to specialists so that no patient would go without care for lack of a willing provider. More than 900 specialists and physician extenders open their doors to treat patients referred by Access Now.',
    'locations': [
      {
        'name': 'RAM',
  ...
  'RCHD Resource Centers': {
    'logo_url': 'http://www.vdh.virginia.gov/images/VDHlogoNew.gif',
    'website_url': 'http://www.vdh.virginia.gov/LHD/richmondcity/clinic.htm',
    'main_contact_name': 'Main Contact Name',
    'description': 'Richmond City Health District Clinical Services are located in the Richmond City Health District building at 400 East Cary Street. The front entrance is located on Main Street. Clinical Services are available to the insured, uninsured and underinsured residents as well as the general public.  Visitor Parking is available in the Cary Street Lot and meter parking on Main and 4th Streets.  Please call 804-482-5500 for more information.',
    'locations': [
      {
...
def service(service_id):
  ...
  # temporarily pass information from the SERVICE_DATA above, since it
  # doesn't exist in the db model yet
  data = SERVICE_DATA[service.name]

  return render_template('service_profile.html', service=service, data=data)
